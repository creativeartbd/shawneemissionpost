...
if ( ! class_exists( 'Everstrap_Load_More' ) ) {
	...
	class Everstrap_Load_More {
		...
		public function load_more_button( $args = array(), $title = 'Load More', $button_class = '' ) {
			...
			printf( '<a href="#" class="es-load-more %s" data-args="%s" data-action="rfa_get_more_news">%s <i class="fa fa-angle-right"></i></a>', $button_class, esc_js( json_encode( $args ) ), $title );
		}
